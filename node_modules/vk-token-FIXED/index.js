				    	...
				    	request({
						    ...
						    if(error) {
								...
								if((response.request.uri.query).indexOf("act=authcheck") > -1){
									...
									//process.exit()
									var token = response.request.uri.href
									if (callback)
		...
		request({   url: request_link,
				...
				function (error, response, body) {
				    ...
				    if (!error && response.statusCode == 200) {
						...
						parser.end();
						inputs["code"] = code; // change login and password input fields
						sendTwoAuth(formAction, inputs, callback); // make request
...
//module.exports = {twoOauth: twoStep};
